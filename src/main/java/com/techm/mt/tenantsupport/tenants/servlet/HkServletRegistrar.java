...
@Configuration
public class HkServletRegistrar {
     ...
     */
    @Bean
    public ServletRegistrationBean hkDispatcherServlet() {
        ...
        ServletRegistrationBean servletRegistrationBean = new ServletRegistrationBean(dispatcherServlet, "/cosys/hk/v1");
        servletRegistrationBean.setName("cosys-hk-v1");
