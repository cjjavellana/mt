...
@Configuration
@ComponentScan(basePackages = {"com.techm.mt.model", "com.techm.mt.tenantsupport.tenants.sg"})
@EnableJpaRepositories(basePackages = {"com.techm.mt.repositories", "com.techm.mt.tenantsupport.tenants.sg.repositories"})
@EnableTransactionManagement
public class SgMysqlJpaConfiguration extends CommonJpaConfigurations {
    ...
    public Properties databaseProperties() {
        ...
        propertiesFactoryBean.setLocation(new ClassPathResource("/META-INF/spring/sg.properties"));
